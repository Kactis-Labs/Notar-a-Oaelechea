    ...
    <section className="services-section">
      <div className="container">
        <div className="services-header">
          ...
          <h2 className="services-title">Áreas de Práctica & Defensa Estratégica</h2>
          <p className="services-subtitle">
            Soluciones jurídicas de alto impacto en Derecho Civil, Laboral, Propiedad Intelectual y Asesoría Empresarial.
          </p>
        </div>

      ...
      <div className="container stats-container">
        ...
        <div className="stats-grid">
          <div className="stat-item">
            <h3 className="stat-number"><AnimatedCounter value="1200" suffix="+" /></h3>
            <p className="stat-label">Casos resueltos con éxito</p>
          </div>
          <div className="stat-item">
            <h3 className="stat-number"><AnimatedCounter value="99" suffix="%" /></h3>
            <p className="stat-label">Efectividad y respuesta rápida</p>
          </div>
          <div className="stat-item">
            <h3 className="stat-number"><AnimatedCounter value="10" suffix="+" /></h3>
            <p className="stat-label">Años de solidez procesal</p>
          </div>
          <div className="stat-item">
            <h3 className="stat-number"><AnimatedCounter value="100" suffix="%" /></h3>
            <p className="stat-label">Confianza y seguridad garantizada</p>
          </div>
        </div>
      </div>
    </section>

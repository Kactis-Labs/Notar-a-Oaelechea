      ...
      <div className="container stats-container">
        ...
        <div className="stats-grid">
          <div className="stat-item">
            ...
            <p className="stat-label">Casos y patrocinios atendidos</p>
          </div>
          <div className="stat-item">
            <h3 className="stat-number"><AnimatedCounter value="99" suffix="%" /></h3>
            <p className="stat-label">Éxito en arbitrajes y litigios</p>
          </div>
          <div className="stat-item">
            <h3 className="stat-number"><AnimatedCounter value="25" suffix="+" /></h3>
            <p className="stat-label">Años de prestigio profesional</p>
          </div>
          <div className="stat-item">
            <h3 className="stat-number"><AnimatedCounter value="100" suffix="%" /></h3>
            <p className="stat-label">Confidencialidad e integridad</p>
          </div>
        </div>
      </div>
    </section>

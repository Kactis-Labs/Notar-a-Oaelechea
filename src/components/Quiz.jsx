...
const quizQuestions = [
  {
    question: '¿Qué servicio jurídico e inmobiliario requiere?',
    options: ['Saneamiento Físico-Legal de Propiedad', 'Asesoría Registral y Contratos Civiles', 'Constitución de Empresa / Persona Jurídica', 'Estudio de Título de Inmueble']
  },
  {
    question: '¿Su predio cuenta con partida registrada en SUNARP?',
    options: ['Sí, con partida e inscripción registral', 'Tiene título pero no está inscrito', 'Poseo contrato privado / minuta', 'Es posesión informal']
  },
  {
    question: '¿Cuál es la prioridad de su trámite en Huaral?',
    options: ['Evaluación inmediata de expediente', 'En las próximas semanas', 'Planificación a mediano plazo']
  },
  {
    question: '¿Cuenta con planos o memoria descriptiva antecedente?',
    options: ['Sí, elaborados por profesional', 'Tengo planos antiguos', 'No cuento con planos']
  }
];
    ...
    <section className="quiz-section">
      <div className="container quiz-container">
        ...
        <div className="quiz-text-col">
          <div className="section-label light">Diagnóstico Inmobiliario & Registral</div>
          <h2 className="quiz-title">¿Necesita sanear su inmueble o formalizar su empresa?</h2>
          <p className="quiz-subtitle">
            Responda 4 preguntas breves y nuestro equipo evaluará el estado físico-legal de su propiedad o trámite registral.
          </p>
        </div>

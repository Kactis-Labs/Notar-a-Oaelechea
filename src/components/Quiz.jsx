...
const quizQuestions = [
  {
    question: '¿En qué área procesal requiere patrocinio legal?',
    options: ['Patrocinio Judicial / Litigios Civiles', 'Derecho Penal / Defensa Procesal', 'Derecho Corporativo / Empresarial', 'Derecho Civil / Propiedad & Familia']
  },
  {
    question: '¿En qué etapa se encuentra su asunto legal?',
    options: ['Demanda o notificación judicial recibida', 'Investigación preliminar fiscal o policial', 'Conflicto comercial o contractual emergente', 'Evaluación preventiva de caso']
  },
  {
    question: '¿Con qué urgencia requiere la intervención de nuestros líderes procesales?',
    options: ['Atención técnica inmediata (Urgente)', 'En los próximos días', 'Esta o la próxima semana']
  },
  {
    question: '¿Cuenta con patrocinio legal previo en esta causa?',
    options: ['Sí, deseo cambiar o reforzar mi estrategia procesal', 'No, es la primera inicio de acciones']
  }
];
    ...
    <section className="quiz-section">
      <div className="container quiz-container">
        ...
        <div className="quiz-text-col">
          <div className="section-label light">Evaluación Procesal Rápida</div>
          <h2 className="quiz-title">¿Enfrentas un problema legal? No estás solo.</h2>
          <p className="quiz-subtitle">
            Responde 4 preguntas breves y nuestro equipo evaluará la estrategia idónea para ganar tu caso.
          </p>
        </div>

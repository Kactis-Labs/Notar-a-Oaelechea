...
export default function TeamPage() {
  const titular = teamMembers.find(m => m.id === 'gabriel-arce') || teamMembers[0];
  const restOfTeam = teamMembers.filter(m => m.id !== 'gabriel-arce');
        ...
        <section className="hero">
          <div className="hero-bg">
            <img 
              ...
              alt="Asociados de Arce & Asociados" 
            />
          ...
          <div className="container hero-content">
            <div className="hero-text">
              <h1 className="hero-title">Asociados elegidos minuciosamente,<br/>alta capacidad resolutiva.</h1>
              <p className="hero-subtitle">
                Ponemos la experiencia, conocimiento y especialidad de nuestro equipo al servicio directo del cliente.
              </p>
            </div>
          </div>
        </section>

...
export default function TeamPage() {
  const titular = teamMembers.find(m => m.id === 'roberto-medina') || teamMembers[0];
  const restOfTeam = teamMembers.filter(m => m.id !== 'roberto-medina');
      ...
      <div className="hero-wrapper" style={{ position: 'relative', zIndex: 1 }}>
        <section className="hero">
          <div className="hero-bg">
            <img 
              src={equipoHero} 
              alt="Equipo de consultores Medina de la Paz S.A.C." 
            />
          ...
          <div className="container hero-content">
            <div className="hero-text">
              ...
              <p className="hero-subtitle">
                Por más de 18 años, hemos acompañado a corporaciones e instituciones en Trujillo protegiendo sus inversiones y gobernanza.
              </p>
            </div>
          </div>
        </section>
      ...
      <div style={{ backgroundColor: 'var(--color-white)' }}>
        ...
        <section className="team-grid-section section-padding bg-light">
          <div className="container">
            <div className="section-label">Especialistas y Consultores</div>
